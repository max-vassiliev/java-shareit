...
class BookingControllerTest {
    ...
    void create_whenItemUnavailable_thenStatusIsBadRequest() {
        ...
        when(bookingService.create(isA(BookingDto.class)))
        ...
        verify(bookingService, times(1)).create(isA(BookingDto.class));
    }
    ...
    void create_whenEndInPast_thenStatusIsBadRequest() {
        ...
        verify(bookingService, never()).create(isA(BookingDto.class));
    }
    ...
    void approve_whenValidAndApproved_thenStatusIsOkAndDtoReturnedWithStatusApproved() {
        ...
        when(bookingService.approve(isA(Long.class), isA(Long.class), isA(Boolean.class)))
                .thenReturn(outputDto);
    ...
    void getById_whenUserIsBooker_thenStatusIsOkAndDtoReturned() {
        ...
        when(bookingService.getById(isA(Long.class), isA(Long.class)))
                .thenReturn(outputDto);
    ...
    void getAllByBookerId_whenUserNotFound_thenStatusIsNotFound() {
        ...
        when(bookingService.getAllByBookerId(isA(Long.class), isA(String.class), isA(Pageable.class)))
                .thenThrow(EntityNotFoundException.class);
        ...
        verify(bookingService, times(1))
                .getAllByBookerId(isA(Long.class), isA(String.class), isA(Pageable.class));
    }
    ...
    void getAllByBookerId_whenStateInvalid_thenStatusIsBadRequest() {
        ...
        when(bookingService.getAllByBookerId(isA(Long.class), isA(String.class), isA(Pageable.class)))
                .thenThrow(BookingStatusException.class);
    ...
    @Test
    @SneakyThrows
    void getAllByBookerId_whenSizeIsZero_thenStatusIsInternalError() {
        Long bookerId = 2L;
    ...
    @Test
    @SneakyThrows
    void getAllByBookerId_whenSizeIsNegative_thenStatusIsInternalError() {
        Long bookerId = 2L;
    ...
    @Test
    @SneakyThrows
    void getAllByBookerId_whenFromIsNegative_thenStatusIsInternalError() {
        Long bookerId = 2L;
    ...
    void getAllByOwnerId_whenUserNotFound_thenStatusIsNotFound() {
        ...
        when(bookingService.getAllByOwnerId(isA(Long.class), isA(String.class), isA(Pageable.class)))
                .thenThrow(EntityNotFoundException.class);
        ...
        verify(bookingService, times(1))
                .getAllByOwnerId(isA(Long.class), isA(String.class), isA(Pageable.class));
    }
    ...
    @Test
    @SneakyThrows
    void getAllByOwnerId_whenSizeIsZero_thenStatusIsInternalError() {
        Long ownerId = 1L;
        String invalidSize = "0";
    ...
    @Test
    @SneakyThrows
    void getAllByOwnerId_whenSizeIsNegative_thenStatusIsInternalError() {
        Long ownerId = 1L;
        String invalidSize = "-1";
    ...
    @Test
    @SneakyThrows
    void getAllByOwnerId_whenFromIsNegative_thenStatusIsInternalError() {
        Long ownerId = 1L;
        String invalidFrom = "-1";
