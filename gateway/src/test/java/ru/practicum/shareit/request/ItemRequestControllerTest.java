...
class ItemRequestControllerTest {
    ...
    void save_whenValid_thenStatusIsOkAndDtoReturned() {
        ...
        when(requestClient.save(isA(Long.class), isA(ItemRequestDto.class)))
        ...
        verify(requestClient, times(1)).save(isA(Long.class), isA(ItemRequestDto.class));
    }
    ...
    void save_whenDescriptionIsEmpty_thenReturnBadRequest() {
        ...
        verify(requestClient, never()).save(isA(Long.class), isA(ItemRequestDto.class));
    }
    ...
    @Test
    @SneakyThrows
    void save_whenUserIdIsZero_thenStatusIsBadRequest() {
        Long requestorId = 0L;
        ItemRequestDto inputDto = createInputDto();
    ...
    @Test
    @SneakyThrows
    void save_whenUserIdIsNegative_thenStatusIsBadRequest() {
        Long requestorId = -1L;
        ItemRequestDto inputDto = createInputDto();
        ...
        verify(requestClient, never())
                .save(isA(Long.class), isA(ItemRequestDto.class));
    }
    ...
    void getById_whenValid_thenStatusIsOkAndDtoReturned() {
        ...
        when(requestClient.getById(isA(Long.class), isA(Long.class)))
                .thenReturn(new ResponseEntity<>(outputDto, HttpStatus.OK));
    ...
    @Test
    @SneakyThrows
    void getById_whenUserIdIsZero_thenStatusIsBadRequest() {
        Long userId = 0L;
        Long requestId = 1L;
    ...
    @Test
    @SneakyThrows
    void getById_whenUserIdIsNegative_thenStatusIsBadRequest() {
        Long userId = -1L;
        Long requestId = 1L;
    ...
    void getAllByRequestorId_whenValid_thenStatusIsOkAndDtosReturned() {
        ...
        when(requestClient.getAllByRequestorId(isA(Long.class)))
    ...
    void getAllByOtherUsers_whenValid_thenStatusIsOkAndDtosReturned() {
        ...
        when(requestClient.getAllByOtherUsers(isA(Long.class), isA(Integer.class), isA(Integer.class)))
                .thenReturn(new ResponseEntity<>(outputDtos, HttpStatus.OK));
        ...
        verify(requestClient, times(1))
                .getAllByOtherUsers(isA(Long.class), isA(Integer.class), isA(Integer.class));
    }
    ...
    @Test
    @SneakyThrows
    void getAllByOtherUsers_whenSizeIsZero_thenStatusIsBadRequest() {
        String size = "0";
        Long userId = 1L;
    ...
    @Test
    @SneakyThrows
    void getAllByOtherUsers_whenSizeIsNegative_thenStatusIsBadRequest() {
        String size = "-1";
        Long userId = 1L;
    ...
    @Test
    @SneakyThrows
    void getAllByOtherUsers_whenFromIsNegative_thenStatusIsBadRequest() {
        String from = "-1";
        Long userId = 1L;
