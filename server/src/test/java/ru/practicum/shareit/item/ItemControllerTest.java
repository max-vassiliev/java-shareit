...
class ItemControllerTest {
    ...
    void getById_whenValid_thenStatusIsOkAndDtoReturned() {
        ...
        when(itemService.getByIdAndUserId(any(), any()))
                .thenReturn(outputDto);
        ...
        verify(itemService, times(1)).getByIdAndUserId(any(), any());
    }
    ...
    void getAllByOwnerId_whenValid_thenStatusIsOkAndDtosReturned() {
        ...
        when(itemService.getAllByOwnerId(any(), any()))
                .thenReturn(itemDtos);
        ...
        verify(itemService, times(1)).getAllByOwnerId(any(), any());
    }
    ...
    void getAllByKeyword_whenValid_thenStatusIsOkAndDtosReturned() {
        ...
        when(itemService.getAllByKeyword(any(), any()))
        ...
        verify(itemService, times(1)).getAllByKeyword(any(), any());
    }
    ...
    void addComment_whenNoPriorBooking_thenStatusIsBadRequest() {
        ...
        verify(itemService, times(1)).saveComment(any());
    }
    ...
    private CommentDto createCommentDto() {
        ...
        commentDto.setText("Comment to Item 1");
        return commentDto;
    }
